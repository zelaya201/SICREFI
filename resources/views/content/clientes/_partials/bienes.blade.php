            ...
            <div class="row my-3 mx-2">
              ...
              <div
                ...
                <div class="invoice_status mb-3 mb-md-0">
                  <button class="btn btn-outline-primary"><i class="tf-icon bx bx-plus"></i>Nuevo bien</button>
                </div>
              </div>
            </div>
            <table class="invoice-list-table table border-top dataTable no-footer dtr-column my-3"
