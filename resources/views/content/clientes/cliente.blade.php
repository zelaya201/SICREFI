...
@section('content')
  <div class="d-flex align-items-center justify-content-between py-3">
    ...
    <a class="btn btn-primary" type="button" href="{{url('pages/account-settings-connections')}}"><span class="tf-icons bx bx-plus-circle"></span> Nuevo Cliente</a>
  </div>

  <!-- Hoverable Table rows -->
  <div class="card">
    <h5 class="card-header">Tabla de clientes</h5>
