...
<ul class="nav nav-pills nav-align-left nav-card-header-pills align-items-center" role="tablist">
  ...
  <li class="nav-item" role="presentation">
    <button type="button" class="btn" role="tab" data-bs-toggle="tab" data-bs-target="#card-conyuge"
  ...
  <li class="nav-item" role="presentation">
    <button type="button" class="btn" role="tab" data-bs-toggle="tab" data-bs-target="#card-datos-negocios"
