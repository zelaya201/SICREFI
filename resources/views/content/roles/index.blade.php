  ...
  <div class=" flex-grow-1 py-3">
    <div
      ...
      <div class="user-profile-info py-1">
        <h4 class="fw-bold m-0"><span class="text-muted fw-light">Roles /</span> Listado de roles</h4>
      </div>
      <ul
        ...
        <li class="list-inline-item fw-semibold">
          <a class="nav-link btn btn-primary load" type="button" href="{{ route('roles.create') }}"><span
              class="tf-icons bx bx-plus"></span> <span class="d-none d-sm-inline-block"> Nuevo rol</span> </a>
        </li>
      </ul>
    </div>
      ...
      <div class="card p-3">
        <div class="card-datatable">
          <div class="dataTables_wrapper dt-bootstrap5 no-footer">
            ...
            <div id="table_div">
              <table id="roles_table" class="table-responsive invoice-list-table table border-top dataTable no-footer dtr-column my-2">
                <thead>
                <tr>
                  <th>#</th>
                  <th>Rol</th>
