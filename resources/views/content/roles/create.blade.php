      ...
      <div class="flex-grow-1">
        <div
          ...
          <div class="user-profile-info">
            <h4 class="fw-bold m-0"><span class="text-muted fw-light">Roles /</span> Nuevo Rol</h4>
          </div>
          <ul
            ...
            <li class="list-inline-item fw-semibold">
              <a class="nav-link btn btn-secondary load" type="button" href="{{ route('roles.index') }}"> Cancelar
              </a>
            </li>
          </ul>
        </div>
